...
function preload(){
  ...
  //carregue o som aqui
  gameOverSound = loudSound("gameover.mp3");
  knifeSound = loudSound("knifeSwoosh.mp3");
}
...
function Monster(){
  if(World.frameCount%200===0){
    ...
    monsterGroup.setVelocityXEach = -(10 + 8* score/4);
    monster.velocityX = -8;
...
function fruits(){
  if(World.frameCount%80===0){
    ...
    fruitGroup.setVelocityXEach = -(6 + 5* score/4);
    fruit.velocityX=-7
    }
    else
    {
